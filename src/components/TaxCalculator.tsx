...
const TaxCalculator: React.FC = () => {
  ...
  // Ensure the currency formatter always displays exactly 2 decimal places
  const formatCurrency = (value: number): string => {
    // Use the rounded value to match the calculation logic
    const roundedValue = roundToCent(value);
